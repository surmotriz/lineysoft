...
<header class="navbar navbar-expand navbar-dark flex-column flex-md-row bd-navbar">
    ...
    <ul class="navbar-nav flex-row ml-md-auto d-none d-md-flex">
        <li class="nav-item dropdown">
            <a class="nav-item nav-link dropdown-toggle mr-md-2" href="#" id="bd-versions" data-toggle="dropdown"
               aria-haspopup="true" aria-expanded="false">v4.0</a>
        ...
        <li class="nav-item">
            <a class="nav-link p-2" href="#" rel="noopener" aria-label="Slack">
    ...
    <a class="btn btn-bd-yellow d-none d-lg-inline-block mb-3 mb-md-0 ml-md-3" href="#">Probar Demo</a>
</header>
    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-6 mx-auto col-md-6 order-md-2">
                <img class="img-fluid mb-3 mb-md-0" src="assets/img/dashboard-img-3.png" alt="" width="800"
                     height="860">
            </div>
            <div class="col-md-6 order-md-1 text-center text-md-left pr-md-5">
                <h1 class="mb-3 bd-text-purple-bright">Factu Electrónica</h1>
                <p class="lead">
                    Genera con rapidez Facturas, Boletas, Notas de credito, Notas de debito y Guias de resimision
                    Electrónicas.
                </p>
                <p class="lead mb-4">
                    Servicio autorizado por la SUNAT para emitir documentos electrónicos,
                    trabajamos con desarrolladores de software, empresas y personas que necesitan ahorrar tiempo y
                    recursos.
                </p>
                <div class="d-flex flex-column flex-md-row lead mb-3">
                    <a href="blog/que-es-facturacion-electronica" class="btn btn-lg btn-bd-purple mb-3 mb-md-0 mr-md-3">¿Qué es.. ?</a>
                    <a href="#" class="btn btn-lg btn-outline-secondary">Probar Demo</a>
                </div>
                <p class="text-muted mb-0">
                    Actualmente la version demo es V0.1
                </p>
            </div>
        </div>
    </div>
...
<div class="masthead-followup row m-0 border border-white">
    <div class="col-12 col-md-4 p-3 p-md-5 bg-light border border-white">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" focusable="false" width="32" height="32" fill="none"
             stroke="currentcolor" stroke-width="2" class="text-primary mb-2" viewBox="0 0 32 32" stroke-linecap="round"
        ...
        <p>Include Bootstrap's source Sass and JavaScript files via npm, Composer or Meteor. Package managed installs
            don't include documentation, but do include our build system and readme.
        </p>
        <hr class="half-rule">
        <a class="btn btn-outline-primary" href="#">Info Desarrolladores</a>
    </div>
    <div class="col-12 col-md-4 p-3 p-md-5 bg-light border border-white">
        <!-- Icon by Bytesize https://github.com/danklammer/bytesize-icons -->
        <svg xmlns="http://www.w3.org/2000/svg" focusable="false" width="32" height="32" fill="none"
        ...
        <h5>CSS only</h5>
        <hr class="half-rule">
        <a class="btn btn-outline-primary" href="#">Info Empresas</a>
    </div>
    <div class="col-12 col-md-4 p-3 p-md-5 bg-light border border-white">
        <!-- Icon by Bytesize https://github.com/danklammer/bytesize-icons -->
        <svg xmlns="http://www.w3.org/2000/svg" focusable="false" width="32" height="32" fill="none"
        ...
        <hr class="half-rule">
        <a href="#" class="btn btn-outline-primary">Info Personas</a>
    </div>
</div>
...
<footer class="bd-footer text-muted">
    <div class="container-fluid p-3 p-md-5">
        ...
        <p>
            ...
            <a href="#" rel="noopener">@mdo</a>
            and <a href="#" rel="noopener">@fat</a>
            . Maintained by the <a href="#">core team</a>
            with the help of <a href="#">our contributors</a>.
        </p>
        <p>
            Currently v4.0.0-beta.2. Code licensed
            <a href="#" rel="license noopener">MIT</a>
            , docs <a href="#" rel="license noopener">CC BY 3.0</a>.
        </p>
    </div>
</footer>
